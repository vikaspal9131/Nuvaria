...
export default function Hero() {
  return (
    <div
      ...
      style={{
        backgroundImage: `url("https://images.unsplash.com/photo-1647346425804-34383b95644b?q=80&w=1332&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D")`,
      }}
    >
      ...
      <div className=" z-10 max-w-4xl mx-auto px-4 pt-20 flex flex-col justify-center items-center">
        ...
        <div className="text-center mb-10">
          <h1 className="text-5xl md:text-6xl font-instrument text-white mb-4">
